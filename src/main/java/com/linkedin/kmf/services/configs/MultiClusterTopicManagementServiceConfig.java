...
public class MultiClusterTopicManagementServiceConfig extends AbstractConfig {
  ...
  public static final String CONFIG_PER_CLUSTER_CONFIG = "topic.management.config.per.cluster";
  public static final String CONFIG_PER_CLUSTER_DOC = "A map from cluster name to a TopicManagementService config for each monitored cluster";
